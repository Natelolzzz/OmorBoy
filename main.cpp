...
long getBatteryPercent() {
  ...
  long new_batt = (voltBat - batteryEmptyVoltage) * (100) / (batteryFullVoltage - batteryEmptyVoltage); // Stupid bodged map function burn it please
...
void setup() {
  ...
  Serial.print(getBatteryPercent());                       // Print the battery capacity percentage
}
